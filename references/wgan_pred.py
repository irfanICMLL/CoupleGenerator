...
parser.add_argument("--input_dir", default='/data/irfan/auto_painter/nb_girls/all_sketch/', help="path to folder containing images")
parser.add_argument("--mode", default='train', choices=["train", "test", "export"])
parser.add_argument("--output_dir", default='/data/irfan/auto_painter/nb_girls/result/wgan_auto_2_v2', help="where to put output files")
